...
contract Anthill2 is IAnthill {
    ...
    function joinTree(address voter, string calldata voterName, address recipient) public virtual {
    ...
    function joinTreeAsRoot(address voter, string calldata voterName) public virtual {
    ...
    function changeName(address voter, string calldata voterName) public virtual {
    ...
    function findRelDepthInner(
        address voter,
        address recipient
    ) public view virtual returns (bool isLocal, uint256 relRootDiff, uint256 rDist) {
    ...
    function addDagVote(address voter, address recipient, uint256 weight) public virtual {
    ...
    function removeDagVote(address voter, address recipient) public virtual {
    ...
    function leaveTree(address voter) public virtual {
    ...
    function switchPositionWithParent(address voter) public virtual {
        address parent = treeVote[voter];
    ...
    function moveTreeVote(address voter, address recipient) public virtual {
        {
